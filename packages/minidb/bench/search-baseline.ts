...
//
// "Without minidb" search baseline over the SAME real ~/.tea-code sessions
...
//
// Run:  node --import tsx bench/search-baseline.ts [--data ~/.tea-code]
...
const DATA = path.resolve(arg('data', path.join(os.homedir(), '.tea-code')));
