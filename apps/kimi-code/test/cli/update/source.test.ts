...
describe('classifyByPathHeuristic', () => {
  ...
  it('detects homebrew on macOS (Cellar path)', () => {
    expect(
      classifyByPathHeuristic('/opt/homebrew/Cellar/tea-code/0.5.0/libexec/lib/node_modules/@futuretea/tea-code'),
    ).toBe('homebrew');
  });

  it('detects homebrew on Linux (Linuxbrew)', () => {
    expect(
      classifyByPathHeuristic('/home/linuxbrew/.linuxbrew/Cellar/tea-code/0.5.0/libexec/lib/node_modules/@futuretea/tea-code'),
    ).toBe('homebrew');
  });
...
describe('detectInstallSource', () => {
  ...
  it('returns homebrew when packageRoot matches Cellar heuristic', async () => {
    await expect(
      detectInstallSource({
        getPackageRoot: () =>
          '/opt/homebrew/Cellar/tea-code/0.5.0/libexec/lib/node_modules/@futuretea/tea-code',
        getGlobalPrefix: async () => '/usr/local',
        detectNative: () => false,
        platform: 'darwin',
      }),
