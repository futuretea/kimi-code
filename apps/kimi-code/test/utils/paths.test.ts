...
describe('getDataDir', () => {
  ...
  it('returns TEA_CODE_HOME when set and ignores the old environment variable', () => {
    process.env['KIMI_CODE_HOME'] = '/tmp/old-kimi-test-data';
    process.env['TEA_CODE_HOME'] = '/tmp/tea-test-data';
    expect(getDataDir()).toBe('/tmp/tea-test-data');
  });
