...
- `pnpm run version:release`: runs Changesets versioning, then appends the required Tea upstream suffix to the app version;
...
- `@futuretea/tea-code` is the fork CLI package name; after a global install it provides the `tea-code` command.
