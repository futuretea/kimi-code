...
const installMacCommand = 'npm install -g @futuretea/tea-code'
const installWinCommand = 'npm install -g @futuretea/tea-code'
const runCommand = 'tea-code'

const copy = computed(() => isZh.value
  ? {
      title: '一行命令开始',
      lede: '装好之后运行 tea-code，立刻在你当前的项目里开聊。',
  ...
  : {
      ...
      lede: 'Once installed, run tea-code inside any project to start a conversation.',
      macLabel: 'macOS / Linux',
      winLabel: 'Windows (PowerShell)',
